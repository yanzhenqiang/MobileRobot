...
(function () {
    ...
    //初始化一般模块
    (function (scope) {
        var modules = ['app', 'automator', 'console', 'dialogs', 'files', 'io', 'selector', 'web', 'ui',
            "images", "threads", "events", "engines", "http", "storages", "floaty",
            "sensors", "media", "plugins", "continuation", "$zip", "$base64", "$crypto"];
